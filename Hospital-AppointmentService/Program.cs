using Hospital_AppointmentService.Service.Impl;
...
builder.Services.AddHttpClient("DoctorById", x =>
{
    x.BaseAddress = new Uri("https://localhost:7284/api/Doctor/");
});


builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "HospitalAppointment", Version = "v1" });
    //For Authorization
